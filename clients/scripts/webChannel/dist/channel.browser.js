(function () {
	...
	(function (global, factory) {
	    factory(exports, axios) ;
	}(commonjsGlobal, (function (exports, axios) {
	...
	}(cherry_ai_umd, cherry_ai_umd.exports));
	...
	cherry_ai_umd.exports.setBaseUrl(baseUrl);
	cherry_ai_umd.exports.setTenant(tenant);

	cherry_ai_umd.exports.apiKeys.exchangeApiKeyAsync({ apiKey })
	    .then(({ access_token }) => {
	        cherry_ai_umd.exports.channels.fetchChannelAsync({ id: channelId, token: access_token });
	    });
