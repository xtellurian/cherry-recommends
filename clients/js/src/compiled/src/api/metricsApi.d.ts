...
export declare const fetchMetricsAsync: ({ token, page, searchTerm }: EntitySearchRequest) => Promise<any>;
export declare const fetchMetricAsync: ({ token, id }: EntityRequest) => Promise<any>;
