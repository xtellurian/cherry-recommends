...
export const fetchCustomerActionAsync = async ({ token, id, category, actionName, }) => {
    return await executeFetch({
...
export const fetchCustomersActionsAsync = async ({ token, page, id, revenueOnly, }) => {
    return await executeFetch({
...
export const fetchCustomerSegmentsAsync = async ({ token, id }) => {
    return await executeFetch({
        token,
