...
export const fetchTrackedUsersEventsAsync = async ({ token, id, useInternalId, }) => {
    return await executeFetch({
...
export const createRecommendationConsumedEventAsync = async ({ token, commonUserId, correlatorId, }) => {
    const payload = {
        commonUserId,
