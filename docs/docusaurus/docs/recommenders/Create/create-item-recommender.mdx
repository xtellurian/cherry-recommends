...
## Choosing a baseline item

It's important to set a reasonable baseline item. As the recommender begins to learn the preferences of Customers,
the baseline item will be shown often. For reporting purposes, other items will be compared to the baseline for performance.
