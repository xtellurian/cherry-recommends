...
By default, new recommenders are configured to track recommendations from every [invokation](/docs/recommenders/Deploy_Recommender/Invoke/invoke-items-recommender).
