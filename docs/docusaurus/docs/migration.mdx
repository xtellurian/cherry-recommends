...
Four2 is changing to Cherry Recommends, but “under the hood” we’re still the same. This document outlines the steps we’ll take together to ensure continuity of service as you move from your single tenant Four2 application to our multi-tenant Cherry Recommends platform.
Migrations Steps
...
Once the migration is complete, all your customer data, recommenders, items, etc. will be available in your new environment. You’ll be able to start getting recommendations from there. It’s important to move to step 3 as soon as possible after step 2 is complete. 
