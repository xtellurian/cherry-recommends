...
Cherry also maintains an internal id for each `Tracked User`.
...
When you invoke a Cherry `Recommender`, the common user id must be provided to identify the customer for whom to make a recommendation.
