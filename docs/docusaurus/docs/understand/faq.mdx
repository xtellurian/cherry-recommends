...
You should have at least 500 customers per week going through the lifecycle stage you want to personalise. The AI will work down to 100 customers per week but performance may drop off.

For example, lets assume you want to increase your free-to-paid conversion rate. You will want at least 500 customers per week (or ~2000 per month) **starting** a trial.
