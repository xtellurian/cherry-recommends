...
namespace SignalBox.Core.Recommendations
{
    public abstract class RecommendationEntity : EnvironmentScopedEntity
    {
        ...
        { }
#nullable enable
        public RecommendationEntity(RecommendationCorrelator correlator, CampaignTypes recommenderType, string? trigger)
        {
        ...
        public CampaignTypes? RecommenderType { get; set; } // nullable for backwards compat
