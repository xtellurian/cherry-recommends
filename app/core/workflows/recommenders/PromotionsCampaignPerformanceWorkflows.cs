...
{
    public class PromotionsCampaignPerformanceWorkflows : CampaignWorkflowBase<PromotionsCampaign>
    {
        ...
        private readonly ILogger<PromotionsCampaignPerformanceWorkflows> logger;

        public PromotionsCampaignPerformanceWorkflows(
            ...
            ILogger<PromotionsCampaignPerformanceWorkflows> logger) : base(store, storeCollection, reportImageWorkflows)
        {
        ...
        public async Task<ItemsRecommenderPerformanceReport> GetOrCalculateLatestPerfomance(string recommenderId, bool? useInternalId = null)
        {
            ...
            await foreach (var recommendation in recommendationStore.Iterate(_ => _.RecommenderId == recommender.Id, IterateOrderBy.AscendingId))
            {
                ...
                else if (recommender.TargetType == PromotionCampaignTargetTypes.Business)
                {
        ...
        private async Task FixRecommmendersWithNullOrEmptyItems(PromotionsCampaign recommender)
        {
