...
{
    public class PromotionsCampaignInvokationWorkflows : CampaignInvokationWorkflowBase<PromotionsCampaign>, IWorkflow
    {
        private readonly ILogger<PromotionsCampaignInvokationWorkflows> logger;
        private readonly IRecommendationCache<PromotionsCampaign, ItemsRecommendation> recommendationCache;
        ...
        public PromotionsCampaignInvokationWorkflows(ILogger<PromotionsCampaignInvokationWorkflows> logger,
                                    ...
                                    IRecommendationCache<PromotionsCampaign, ItemsRecommendation> recommendationCache,
        ...
        public async Task<ItemsRecommendation> InvokePromotionsCampaign(
            PromotionsCampaign recommender,
            ...
            string? trigger = null)
        {
            ...
            {
                string commonId;
                if (recommender.TargetType == PromotionCampaignTargetTypes.Customer)
                {
                ...
                else if (recommender.TargetType == PromotionCampaignTargetTypes.Business && input.BusinessId != null)
                {
        ...
        private async Task<ItemsRecommendation> HandleRecommendation(PromotionsCampaign recommender,
