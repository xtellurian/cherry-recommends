...
namespace SignalBox.Test.Workflows
{
    public class KlaviyoWorkflowTests
    {
        ...
        public async Task SetApiKeysTest()
        {
            ...
            var workflow = new KlaviyoSystemWorkflow(new System.Net.Http.HttpClient(), mockIntegratedSystemStore.Object, Utility.MockLogger<KlaviyoSystemWorkflow>().Object);
