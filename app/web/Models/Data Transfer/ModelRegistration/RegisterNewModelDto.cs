...
namespace SignalBox.Web.Dto.ModelRegistration
{
    public class RegisterNewModelDto : DtoBase
    {
        ...
        [Required]
        [RegularExpression("SingleClassClassifier|ParameterSetRecommenderV1|ProductRecommenderV1|ItemsRecommenderV1",
            ErrorMessage = "SystemType must be one of SingleClassClassifier, ParameterSetRecommenderV1, ProductRecommenderV1, ItemsRecommenderV1")]
