...
import { createPromotionsCampaignAsync } from "../../../api/promotionsCampaignsApi";
import {
...
export const CreateCampaign = () => {
  ...
  const handleCreate = () => {
    ...
    createPromotionsCampaignAsync({
      ...
      .then((r) => {
        analytics.track("site:itemsCampaign_create_success");
        navigate(`/campaigns/promotions-campaigns/detail/${r.id}`);
      })
      .catch((e) => {
        analytics.track("site:itemsCampaign_create_failure");
        setError(e);
      })
  ...
  return (
    <React.Fragment>
      <CreatePageLayout
        ...
        backButton={
          <MoveUpHierarchyPrimaryButton to="/campaigns/promotions-campaigns">
            Back to Campaigns
          </MoveUpHierarchyPrimaryButton>
        }
