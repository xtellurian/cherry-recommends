        ...
        <React.Fragment>
          ...
          <SettingRow
            ...
            description="By default, all recommendations are assumed to be consumed, i.e.
              ...
              you may wish to invoke a campaign and only later decide whether
          ...
          <SettingRow
            ...
            description="By default, a new recommendation will be generated every time this campaign is invoked.
          ...
          <SettingRow
            label="Schedule"
            description="Choose a schedule for which the campaign will stop producing recommendations.
            Setting an expiry date will make the campaign expire at end of day in UTC timezone."
          >
            <ScheduleUtil
