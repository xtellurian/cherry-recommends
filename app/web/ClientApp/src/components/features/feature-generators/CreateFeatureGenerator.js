...
import { LearnMoreAboutFeatureGenerators } from "./LearnMoreAboutFeatureGenerators";
...
export const CreateOrEditFilterSelectAggregateFeatureGenerator = ({
  feature,
  onCreated,
}) => {
  ...
  const [generator, setGenerator] = React.useState({
    featureCommonId: feature.commonId,
  ...
  return (
    <React.Fragment>
      ...
      <LearnMore
        ...
        tooltip="Learn More about Feature Generators"
      >
        <LearnMoreAboutFeatureGenerators />
      </LearnMore>
